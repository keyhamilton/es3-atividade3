...
public class ImpostoDeRenda {
    ...
    public void processar(List<ValidacaoImposto> validacoes) throws Exception{
        ValidacaoImpostoDeRenda validacaoImpostoDeRenda = new ValidacaoImpostoDeRenda(validacoes);
        try {
            validacaoImpostoDeRenda.validarImposto(this);
            ...
            System.out.println("Ocorreu um erro durante o processamento");
        }
